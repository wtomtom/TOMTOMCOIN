...
#if defined(NDEBUG)
# error "tomtom cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "tomtom Signed Message:\n";
...
#ifdef ENABLE_WALLET
// tomtom: attempt to generate suitable proof-of-stake
